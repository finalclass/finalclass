  ...
  invokeFeatures: {
    value: function (obj, features, method) {
      ...
      Object.keys(features).forEach(function (featureName) {
        ...
        Object.keys(this.dirtyDescriptor).forEach(function (property) {
          if (this.dirtyDescriptor[property][featureName] && feature[method] !== undefined) {
            feature[method](obj, property, this.dirtyDescriptor[property][featureName]);
          }
        }, this);
      }, this);
    }
